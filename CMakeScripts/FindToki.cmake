...
IF (Toki_FOUND)
   set(Toki_VERSION 0.0)
   set(Toki_MAJOR_VERSION 0)
   set(Toki_MINOR_VERSION 0)
   ...
   IF (_Toki_VERSION_FILE)
      ...
      STRING(REGEX REPLACE ".*#define LIBTOKI_VERSION_MAJOR ([0-9]+).*" "\\1" Toki_MAJOR_VERSION "${_Toki_VERSION_CONENTS}")
      STRING(REGEX REPLACE ".*#define LIBTOKI_VERSION_MINOR ([0-9]+).*" "\\1" Toki_MINOR_VERSION "${_Toki_VERSION_CONENTS}")
      set(Toki_VERSION "${Toki_MAJOR_VERSION}.${Toki_MINOR_VERSION}")
